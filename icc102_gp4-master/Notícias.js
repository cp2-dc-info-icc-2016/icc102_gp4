...
function exibeDetalhes(item) {
  document.getElementById("titulo").innerHTML = item.titulo;
  document.getElementById("titulo2").innerHTML = item.titulo;
  document.getElementById("titulo3").innerHTML = item.titulo;
  document.getElementById("texto").innerHTML = item.descricao;
  document.getElementById("texto2").innerHTML = item.descricao;
  document.getElementById("texto3").innerHTML = item.descricao;
}

var codigo = getParameterByName('codigo');
exibeDetalhes(noticias[codigo]);
